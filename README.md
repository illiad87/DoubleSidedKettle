...
### Motivation
The core idea of this project is that a preparation method that uses convection infuses a richer taste in tea compared to a standard conduction method. My goal here was to design a 3D CAD model of a kettle that would allow steam to pass from a body of water to a body of tea, cooking it in the process.
